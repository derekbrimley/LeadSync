		...
		<div id="main_content" class="main_content">
			...
			<div class="call_form_container">
				...
				<?=form_open(base_url('index.php/call_form/update_lead'),$attributes);?>
					...
					<div style="float:right" class="slide" id="emergency_contact_slide">
						<div class="slide_title">Emergency Contact</div>
						<div class="slide_script">
							<p>"Could you give me an emergency contact phone number?"</p>
						</div>
						<div class="slide_response">
							<table>
								<tr>
									...
									<td>
										<input placeholder="555-555-5555" class="call_form_input" type="text" id="emergency_contact_input" name="emergency_contact_input"/>
									</td>
								</tr>
							</table>
						</div>
						<button type="button" onclick="emergency_contact_next()" class="next_button">NEXT</button>
					</div>
					...
					<div style="float:right" class="slide" id="fifteen_week_slide">
						<div class="slide_title">Fifteen Week Committment</div>
						<div class="slide_script">
							<p>"Are you OK with being away from home for 15 weeks?"</p>
						</div>
						<div class="slide_response">
							<table>
								<tr>
									...
									<td>
										<select class="call_form_input" id="fifteen_week_question" name="fifteen_week_question">
											<option value="">Select</option>
											<option>Yes</option>
											<option>No</option>
										</select>
						...
						<button type="button" onclick="fifteen_week_next()" class="next_button">NEXT</button>
					</div>
					...
					<div style="float:right" class="slide" id="inbound_or_outbound_slide">
						...
						<div class="slide_script" style="height:120px;">
					...
					<div style="float:right" class="slide" id="otr_6_slide">
						...
						<div class="slide_script">
							"Just so you know, we do not have any local or regional routes. <br><br>Once you get your CDL, and are offered a job, are you OK with driving over the road for 6 weeks at a time?"
						</div>
						<div class="slide_response">
							<table>
								<tr>
					...
					<div style="float:right" class="slide" id="six_week_slide">
					...
					<div style="float:right" class="slide" id="two_week_slide">
						<div class="slide_title">Two Week Committment</div>
						<div class="slide_script">
							<p>"Are you willing to do two weeks over the road?"</p>
						</div>
						<div class="slide_response">
							<table>
								<tr>
									...
									<td>
										<select class="call_form_input" name="two_weeks_question" id="two_weeks_question">
											<option value="">Select</option>
											<option>Yes</option>
											<option>No</option>
										</select>
					...
					<div style="float:right" class="slide" id="valid_cdl_slide">
						...
						<div class="slide_response">
							<table>
								<tr>
									...
									<td>
										<select class="call_form_input" name="valid_cdl_question" id="valid_cdl_question">
											<option value="">Select</option>
											<option>Yes</option>
											<option>No</option>
										</select>
						...
						<button type="button" onclick="valid_cdl_next()" class="next_button">NEXT</button>
					</div>
					<div style="float:right" class="slide" id="valid_license_slide">
						...
						<button type="button" onclick="valid_license_next()" class="next_button">NEXT</button>
					</div>
				</form>
			</div>
		</div>
